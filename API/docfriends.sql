...
(1, 'admin@test.com', '', '정동원 원장', '', '2020-06-13 12:16:54', '', 0, '2020-06-13 12:16:54', '');
...
(1, '수원풍덕천 37/남 교통사고 한의원치료, 계속 누워있는데 어쩌고저쩌고', '교통사고로 팔 수술을 하였습니다. 현재 깁스 하면서 현재 정형회과 입원중인데 계속 누워있으니온몸이 뻐근하고 목어깨 쪽에도 통증이 와서 퇴원 후 한의원을 다녀볼까 합니다. 접수번호만 있으면 어쩌고저쩌고 뒤쪽 잘릴 예정', '한방재활의학과', '', 0, '2020-06-13 12:45:20', '', 0, '2020-06-13 12:33:33', '', 1),
(2, '울산 23/여 여드름, 사용하던 선크림이 단종돼서 다른걸 썼는데 망한 듯한...', '선크림 영향인지 모르겠지만 최근 어쩔 수 없이 선크림 사용하던 걸 바꿨는데 이런 걸로 여드름이 생길 수 있나요??? 안 바르고 다닐 수도 없고 ㅠㅠ 그렇다고 이것저것 다 써볼수도 없구요 만약 어쩌고저쩌고 재잘재잘 아아아아아아', '한방피부과', '', 0, '2020-06-13 12:45:25', '', 0, '2020-06-13 12:33:38', '', 1),
(3, '수원 24/남 여드름, 피부가 건조하면 등여드름이 잘 생기나요?', '제가 얼굴이며 몸이며, 피부가 정말 악건성인데...등여드름이 정말 자주 생겨요.\r\n\r\n바디로션도 꾸준히 바르는데, 심하진 않아도 주기적으로 자잘하게 등여드름이 생기면 어떻게 해결해야 하는거죠? (수원 20대 중반/남 여드름)', '한방피부과', 'http://miraesol.com/mi...plyonlineview?id=9194', 0, '2020-06-13 12:45:29', '', 0, '2020-06-13 12:33:37', '', 1);
